          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Summary</div>
                <div class="detail-content">
                  After upload, the LLM analyzes the documents and generates an ontology suited to the simulation, including entity and relation types.
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Summary</div>
                <div class="detail-content">
                  Based on the generated ontology, chunks the documents and calls the Zep API to build the knowledge graph, extracting entities and relations.
                </div>
              </div>
...
const getApiErrorMessage = (err, fallback = 'Unknown error') => {
...
const handleNewProject = async () => {
  ...
  try {
    ...
    error.value = getApiErrorMessage(err, 'Project initialization failed')
  } finally {
    loading.value = false
  }
}

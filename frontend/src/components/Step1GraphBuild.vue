    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            The LLM analyzes your documents and simulation goal, extracts real-world seeds, and generates an ontology tailored to the scenario.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Using the generated ontology, the system chunks the documents, builds a knowledge graph with Zep, extracts entities and relations, and forms temporal memory plus community summaries.
          </p>

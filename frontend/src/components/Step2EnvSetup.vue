    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Create a new simulation instance and load the world-parameter template.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Using the graph context, the system identifies entities and relations, initializes simulated individuals, and gives them distinct behavior and memory grounded in the seed material.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            The LLM uses the simulation goal and seed material to set world time flow, recommendation behavior, active hours, posting frequency, and event triggers.
          </p>
                ...
                >
                  ...
                  <div class="agent-params">
                    ...
                    <div class="param-group">
                      ...
                      <div class="param-item">
                        <span class="param-label">Influence Weight</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            Automatically generate initial activation events and trending topics based on narrative direction to guide the simulation world's initial state.
          </p>
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                ...
                <span class="section-desc">MiroFish will simulate <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> hours of reality, with each round representing <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> minutes passing.</span>
              </div>
              ...
              <div v-else class="rounds-content auto" key="auto">
                <div class="auto-info-card">
                  ...
                  <div class="auto-content">
                    ...
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">If running for the first time, it is strongly recommended to switch to ‘Custom Mode’ to reduce simulation rounds for a quick preview and lower error risk. ➝</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              ...
              <div class="dimension-card">
                ...
                <span class="dim-desc">Experience summary and behavioral style</span>
              </div>
              <div class="dimension-card">
...
const handleEnvironmentSetupFailure = (message) => {
  stopPolling()
  stopProfilesPolling()
  stopConfigPolling()
  addLog(`Environment setup failed: ${message || 'Unknown error'}`)
  emit('update-status', 'error')
}
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      if (data.status === 'failed') {
        handleEnvironmentSetupFailure(data.error)
        return
      }
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.status === 'failed') {
        handleEnvironmentSetupFailure(res.data.error)
